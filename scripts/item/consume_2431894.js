...
function action(mode, type, selection) {
    ...
    return;
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var text = "#b마스터 미라클 큐브 조각 #r#c2431894#개#k를 가지고 있습니다. 은빛 각인의 인장은 #r10개#k, 고급 장비강화 주문서는 #r20개#k, 에픽 잠재능력 주문서 80%는 #r30개#k를 사용하여 교환할 수 있습니다.\r\n\r\n";
		...
		text += "#b#L2##i2049701# #z2049701##l";
            ...
            if (selection == 0) {
                if (cm.haveItem(2431894, 10)) {
		    cm.sendYesNo("정말 #b#i2049501# #z2049501##k로 바꾸시겠습니까?");
		    select = 0;
                } else {
                    cm.sendNext("죄송하지만 #b#z2431894##k이 충분하지 않으신것 같네요.");
		    cm.dispose();
                }
            } else if (selection == 1) {
                if (cm.haveItem(2431894, 20)) {
