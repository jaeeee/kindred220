		...
		switch(chance){
 			...
 			case 11:
				...
				var whatup = "업그레이드 가능 횟수";
 				break;
 			case 12:
 				option.setAcc(option.getAcc() + chance_two);
				var whatup = "명중치";
 				break;
 			case 13:
 				option.setAvoid(option.getAvoid() + chance_two);
				var whatup = "회피치";
 				break;
 			default:
