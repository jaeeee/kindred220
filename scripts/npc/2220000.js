...
function action(mode, type, selection) {
	...
	var chat = "#r크로스헌터 마스터#k에 도전해보시겠습니까? \r\n#r크로스헌터 마스터#k가되시면 많은 해택을 누리실 수 있습니다.\r\n#i1142354# #b#z1142354##k\r\n\r\n#g견습#k,#d정식#k,#b전문#k,#r마스터#k 별로 보스 몬스터가 있습니다.\r\n";
	//chat +="#r#e[]#k#n\r\n";
	//if (cm.haveItem(1003142)){
	//chat +="#b#e#L22#운영자가 되고 싶습니다.#n#l\r\n\r\n"
	chat +="#L1##g견습 크로스헌터#k#l\r\n";
	chat +="#L2##d정식 크로스헌터#k#l\r\n";
	chat +="#L3##b전문 크로스헌터#k#l\r\n";
	chat +="#L4##r크로스헌터 마스터#k#l\r\n\r\n";
...
// 사냥터 질문
	...
	cm.sendOk("#b크로스헌터#k의 길에 첫발을 내딛으신걸 축하드립니다. 앞으로 더욱 성장하시기 바랍니다.")
        WorldBroadcasting.broadcast(MainPacketCreator.getGMText(5, "[크로스헌터] "+ cm.getPlayer().getName()+" 님께서 견습 크로스헌터가되셨습니다.")); // 게임 채팅서버알림 메세지
...
// 프리미엄 사냥터(이지) 이동
	...
	cm.sendOk("이제 어엿한 #b정식 크로스헌터#k가되셧군요. 축하드립니다.")
        WorldBroadcasting.broadcast(MainPacketCreator.getGMText(5, "[크로스헌터] "+ cm.getPlayer().getName()+" 님께서 정식 크로스헌터가되셨습니다.")); // 게임 채팅서버알림 메세지
...
// 프리미엄 사냥터(노말) 이동
	...
	cm.sendOk("벌써 #b전문 크로스헌터#k가 되시다니 역시 제가보는눈은 틀림없습니다. 진심으로 축하드립니다.")
        WorldBroadcasting.broadcast(MainPacketCreator.getGMText(5, "[크로스헌터] "+ cm.getPlayer().getName()+" 님께서 전문 크로스헌터가되셨습니다.")); // 게임 채팅서버알림 메세지
...
// 프리미엄 사냥터(하드) 이동
	...
	cm.gainItem(1142353, -1);
	cm.sendOk("드디어 #b크로스헌터 마스터#k가되셧군요! 서버의 최정상에 도달하신걸 진심으로 축하드립니다. #b크로스헌터 마스터#k의 명예를 누리시길!")
        WorldBroadcasting.broadcast(MainPacketCreator.getGMText(5, "[크로스헌터] "+ cm.getPlayer().getName()+" 님께서 렌시아온라인 최강 크로스헌터 마스터가되셨습니다!")); // 게임 채팅서버알림 메세지
        WorldBroadcasting.broadcast(UIPacket.detailShowInfo(""+ cm.getPlayer().getName()+"님이 최강 크로스헌터 마스터가되셨습니다."));
	...
	} else if (selection == 1999 ) { // cm.getPlayer().send
