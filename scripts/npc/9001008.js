...
function action(mode, type, selection) {
	...
	var chat = "보스에 대미지를 가해도 대미지가 줄지 않는 것처럼 보이나 이는 겉 값이고 실제로 대미지는 들어가니 참고 부탁드립니다.\r\n";
	//chat +="#r#e[]#k#n\r\n";
	//if (cm.haveItem(1003142)){
	//chat +="#e#L22#운영자가 되고 싶습니다.#n#l\r\n\r\n"
	chat +="#e#L10000##e[반 레온]#n #b알현실#k\r\n"
	chat +="#e#L10001##e[자쿰]#n #b자쿰으로통하는문#k\r\n"
	//chat +="#e#L10002##e[카오스 자쿰]#n #b카오스 자쿰으로 통하는문#k\r\n"
	chat +="#e#L10003##e[아카이럼]#n #b아카이럼의 제단#k\r\n"
	chat +="#e#L10004##e[힐라]#n #b힐라의 탑#k\r\n"
	chat +="#e#L10005##e[시그너스]#n #b시그너스의 전당#k\r\n"
	chat +="#e#L10009##e[매그너스]#n #b폭군의 왕좌#k#k#n\r\n"
	chat +="\r\n#l#e< 루타비스 >#n #r#e(4인 파티 권장)#k#n\r\n"
	chat +="#e#L10006##e[카오스 피에르]#n #b오후의 티 테이블#k\r\n"
	chat +="#e#L10007##e[카오스 블러디 퀸]#n #b여왕의 성#k\r\n"
	chat +="#e#L10008##e[카오스 벨룸]#n #b심연의 동굴#k\r\n"
...
// 프리미엄 사냥터(하드) 이동
	...
	cm.dispose();
        ...
        cm.sendOk("레벨 210이상의 유저는 시그너스를 잡으실 수 없습니다.");
        cm.dispose();
        }
        ...
        cm.sendOk("레벨 210이상의 유저는 아카이럼을 잡으실 수 없습니다.");
        cm.dispose();
        }
