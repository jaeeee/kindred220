...
function action(mode, type, selection) {
 status++;
 if (status == 0) {
  cm.sendSimple("#e휼륭하군 휼륭해..#k \r 자네는#r검은 마법사#k 한테 도전할 권리가 있네.. \r 하지만 앞으로 힘든 여정이 되겠지..그래도도전하겠나?   #L1##e#r#i3994385#500개#k:#e#b챕터1-2#k:#e#d흩어진 문의 열쇠를 구하여라!.");
 } else if(status == 1) {
  if(selection == 10) {
...
cm.warp(1040400002, 0);
 ...
 cm.dispose();
  ...
  cm.TimeMoveMap(105200410,100000000,300); //8860003
            }
cm.dispose();
  } else if (selection == 2) {
