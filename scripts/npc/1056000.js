...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
	if (cm.getPlayer()) {
            var chat = "Jewel Craft wanted to know about the system?\r\n";
	    chat += "#e#b#L102#Jewel Craft#k#nWhat?\r\n";
	    chat += "#L104#Needed for synthesis #e#bgem#k#nKind of?\r\n";
	    chat += "#e#b#L100#Jewel ring#k#n To produce\r\n";
	    chat += "#e#b#L101#Jewel Belt#k#n To produce";
	    cm.sendSimple(chat);
	}
        } else if (status == 1) {
	    if (selection == 100) {
	       var chat = "Hello #h0#sir! I am now #e#bBeautiful Jewelry#n#kI'm making a. Jewel ring, I tend to get a chance in a mob boss Reid to hold or otherwise with the belt-\r\n#e#rJewel Craft Ring#n#k and #e#rJewel#n#kCombining this #e#bBeautiful Jewelry#n#kThe birth !!";
	       chat += "\r\n\r\n#bPlease choose an item below.#k\r\n";
	       ...
	       var chatt = "Hello #h0#sir! I am now #e#bPretty jewel belts#n#kI'm making a.\r\n#e#rJewel Craft Ring#n#k and #e#rJewel#n#kCombining this #e#bBeautiful Jewelry#n#kThe birth!!";
	       chatt += "\r\n\r\n#bPlease choose an item below.#k\r\n";
	       ...
	       cm.sendSimple(chatt);
           	...
           	cm.sendOk("When Jewel Craft is a synthetic jewels with special powers to the item it does not have any powers, Need special equipment to jewelry to transfer the ability to have the equipment items.");
		cm.dispose();
             } else if (selection == 103) { // 쥬얼 시너지 란?
           	cm.sendOk("#i2048402# That's right Jewel synergies. If you ever have two or more Jewel do not need you, try using the Jewel synergies. Jewel do not need to synthesize the two of you do not know me you might be able to get the desired jewel.");
		cm.dispose();
             } else if (selection == 104) { // 합성에 필요한 종류는?
           	cm.sendOk("#i1112762# This particular need to synthesize Jewel Craft Jewel ring abilities. Nestled magical abilities aftershocks have been granted special jewelry. We call it as Jewel.");
		cm.dispose();
		...
		if (cm.haveItem(4440000, 1) && (cm.haveItem(1112762, 1))) {
		    if (cm.canHold(1112763)) {
		        cm.sendOk("S bought the jewel ring of class forces.");
		    ...
		    cm.sendOk("\r\n#e#r[There is not enough material. ]#l#n");
		    cm.dispose();
