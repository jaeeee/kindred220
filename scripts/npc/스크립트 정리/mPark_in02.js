...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "어느 곳으로 입장하시겠습니까?\r\n#r(레벨 160이상 유저 이용 가능)\r\n당신은 금일 몬스퍼 파크를 0회 클리어하였습니다. (메이플 계정 기준)\r\n#b#L10#폐허가 된 도시(Lv.160~169)#l\r\n#L11#죽은 나무의 숲(Lv.170~179)#l\r\n#L12#감시의 탑(Lv.175~184)#l\r\n#L13#용의 둥지(Lv.180~200)#l\r\n#L14#망각의 신전(Lv.185~194)#l\r\n#L15#기사단의 요새(Lv.190~199)#l\r\n#L16#원혼의 협곡(Lv.200~250)#l#k";
        cm.sendSimple(text);
    } else if (status == 1) {
        var map = 100000000;
        switch (selection) {
