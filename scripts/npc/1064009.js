...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	    cm.sendSimple("#b#L1##i2541007# Head shape#l　#L3##i5152057# Face#l#e　#n#L6##i1662039# Android\r\n\r\n#L0##i5153015# #bSkin color#l　#L2##i5151036# dyeing#l　#L4##i5152100# Colored lenses\r\n\r\n#L5##i4000526# To change the gender.");
    } else if (status == 1) {
        if (selection == 6) {
            cm.dispose();
            cm.openNpc(1012123);
	...
	if (cm.getPlayer().getGender() == 0) {
	    if (selection == 0) {
		beauty = 1;
		cm.askAvatar("Please select the desired skin.", skin);
	    } else if (selection == 1) {
		beauty = 2;
		hairnew = Array();
		...
		cm.askAvatar("Please select your avatar.", hairnew);
	    } else if (selection == 2) {
		beauty = 3;
		haircolor = Array();
		...
		cm.askAvatar("Please select your avatar.", haircolor);
	    } else if (selection == 3) {
		beauty = 4;
		facenew = Array();
		...
		cm.askAvatar("Please select your avatar.", facenew);
	    } else if (selection == 4) {
		beauty = 5;
		...
		cm.askAvatar("Please select your avatar.", colors);
	    }
	} else {
	    if (selection == 0) {
		beauty = 1;
		cm.askAvatar("Please select your avatar.", skin);
	    } else if (selection == 1) {
		beauty = 2;
		hairnew = Array();
        ...
        if (selection == 5) {
            select = selection;
            cm.sendYesNo("Do you really want a sex change?");
        }
    } else if (status == 2) {
