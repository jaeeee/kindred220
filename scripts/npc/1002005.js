...
function action(mode, type, selection) {
	...
	if (total_i > 2){
	WorldBroadcasting.broadcast(MainPacketCreator.serverNotice(6, ":::::::::"+ cm.getPlayer().getName()+"님이 "+total_i+"빙고에 당첨되셨습니다.:::::::::"));
	}
	cm.gainMeso(((text*(total_i*0.7))-text));
        cm.dispose();
		} else {
		cm.sendOk("1000000보다 큰 숫자를 입력해주세요");
		cm.dispose();
		}
	}else {
