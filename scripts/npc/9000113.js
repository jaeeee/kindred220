var list48 = [1112900,1112901,1112908,1112924,1112925,1112926]; // 캐릭터 반지 아이템
...
function action(mode,type,selection) {
	...
	showSecondShop();
        ...
        cm.sendGetNumber("메소로 환전을 원하시는 마일리지를 입력해주세요\r\n#r※ 1 마일리지#k = #b20000 메소#k",1,0,cm.getPlayer().getRC());
	...
	cm.sendGetNumber("\r\n#e선택 아이템#n : #i"+itemid+"# #z"+itemid+"#\r\n#e아이템 가격#n : #b#e"+cost+"#n 마일리지#k\r\n\r\n#e#Cgray#※ "+allstatprice+" 마일리지 = 올스텟 ＋"+allstat+" #k#n\r\n#r※ 500 마일리지#k = #b공격력/마력 ＋3#k",0,0,cm.getPlayer().getRC()  - cost);
}
}
	} else if (status == 3) {
	if (selected == 999999) {
...
function showExplanation() {
	cm.sendOk("#e#r<신개념 서비스 : 마일지샵>#k : 마일리지를 얻어봅시다!~#n\r\n\r\n　① 채팅방 내에서 #e' 카인(achermusic) '#n 에게 대화하기 \r\n　② 게임 내에서 #e' 카인 '#n 에게 대화하기\r\n\r\n　③ 네이트온 #e' achermusic@nate.com '#n 에게 대화!\r\n\r\n#k#b위 방법들을 제외하고 다른 방법으로 마일리지를 획득 또는 거래시 심각한 불이익을 당할수 있습니다. 꼭 명심해주세요!!#k");
	    cm.dispose();
}
