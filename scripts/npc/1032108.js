...
function action(mode, type, selection) {
 if (mode == -1) {
  ...
  if (status == 0) {
cm.sendSimple("#e#dI am responsible riding #e#b[Marty Earth]#k#e#dHey!"+"#k\r\n\r\n#L2##e#r[Riding] I'll learn the skill.\r\n#k#L1##e#r[Riding] Purchase promote riding");
	...
	cm.sendOk("#e#bHe completed all riding!#e#r\r\n\r\n(Skill> to go riding!)");
