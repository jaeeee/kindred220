...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    	...
    	var takejob = "#r※[필수] 변생을 위해 장착중인 아이템을 모두 벗어주세요. \r\n#r + 변생을 할시 후원,홍보,낚시,레어포인트가 초기화됩니다.\r\n#b추천스쿼드: 소마-히어로-카이져 / 캐논-모험가류\r\n#b추천스쿼드: 모든 법사류만 계속 / 닼나 - 아란(폴암류)";
		takejob += "\r\n#k어느 직업군으로 변생 하시겠습니까?\r\n"
		takejob += "#e#r#L0#모험가#l　　";	
		takejob += "#L1000#시그너스#l　　　#n#k\r\n";
		takejob += "#b#L2000#아란　　　#l";
		takejob += "#L2001#에반#l　　　　";
		takejob += "#L1100#소울마스터#l　　\r\n";
		...
		cm.sendOk(" 변생은 #b새로운 직업군으로 다시 태어나는것#k을 말합니다. 변생을 하면 #b현재 가지고 있는 스탯, 저장된 퀵슬롯 스킬을 가지고 처음부터 다시 시작#k할수 있게됩니다.\r\n 변생은 환생포인트 5000이 필요하며, 불가피하게 다른 직업으로 변생했을 경우 되돌릴 수 없으니 신중하게 선택해 주셔야합니다.\r\n #r만약 착용중인 아이템을 장착하고 변생을 하게 된다면 아이템이 초기화가 될수도 있습니다.#k 이 주의사항을 무시한채 변생을 할 경우에는 복구가 불가능합니다.");
		cm.dispose();
		} else {
		if (job == 1) {
		cm.sendOk("신중히 생각하고 다시 말을 걸어주세요.");
		...
		cm.sendOk(" 환생포인트가 부족하거나 레벨이 #r250#k이 아닙니다. 참고로 제로 직업군은 변생이 불가합니다. \r\n 변생은 #b5000#k의 환생포인트가 필요합니다.");
		cm.dispose();
		}
		}
