...
var status = 0;
var drugs = [4033366, 2049750, 2049153, 2590008];
var cost = [5000, 3000, 500, 2000];
var text;
        ...
        status++; 
    		...
    		if (selection == 62) {
    			if (cm.getPlayer().getCSPoints(2) < 20000) {
    				cm.sendOk("Sorry, you need at least 20000 Maple Points to complete this trade.");
    				cm.dispose();
    				return;
    			}
    			cm.getPlayer().modifyCSPoints(2, -1 * 20000, true);
