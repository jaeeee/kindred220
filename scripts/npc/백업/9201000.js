	...
	cm.sendSimple("#i"+item+"# #r"+count+"개#k로 "+bn+"을 소환하겠습니까? \r\n\r\n#L1##r#i"+item+"# #r"+count+"개#k로 "+bn+" 소환\r\n#l#L2#마을로 가기#l#k\r\n\r\n#l#L3##b계속죽이라고할때클릭해주세요.<킬올시스템>\r\n		(아이템 드랍은 되지않습니다.)#l#k\r\n");
		...
		if(selection == 1) {//소환
			...
			cm.gainItem(item,-count);
 			cm.spawnMob(8800100,-20,-216);
 			cm.spawnMob(8800110,-20,-216);
 			cm.spawnMob(8800108,-20,-216);
 			cm.spawnMob(8800109,-20,-216);
 			cm.spawnMob(8800106,-20,-216);
 			cm.spawnMob(8800107,-20,-216);
 			cm.spawnMob(8800104,-20,-216);
 			cm.spawnMob(8800105,-20,-216);
 			cm.spawnMob(8800103,-20,-216);
			cm.dispose();
		}
