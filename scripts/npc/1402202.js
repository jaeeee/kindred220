...
var j_coin = cm.itemQuantity(4001620);
   var text = "흠.. 자네에게서 심상치않은 기운이 느껴지는군..\r\n\r\n(레벨 250 달성시 지급되는 봉인의 편지 필요)\r\n";
 //  text += "\r\n#e#b현재 고객님이 보유하고 계신 증표는 #r#n#e"+j_coin+"#k #e개입니다.#k\r\n";
//   text += "\r\n\r\n#l#e<장갑>#n";
//   text += "\r\n#L3##i1082392# - 올탯50 공10 - #r8개/잠재:총댐20퍼,올텟20퍼,보공40퍼#k\r\n\r\n";
   text += "\r\n#l#fUI/UIWindow2.img/UtilDlgEx/list5\r\n";
   text += "\r\n#L4# #i1112940# #b메이플러 반지#k (올스텟 5000 공/마 2500)";   
 /*  text += "\r\n#L5# #i1102377# - 올탯50 공10 - #r5개#k";
  ...
  text += "\r\n#L7# #i1102511# - 올탯50 공10 - #r5개#k";
   ...
   if (selection == 0) {
    ...
    if (cm.haveItem(4031099, 1)) {
     cm.gainItem(4031099, -1);
     cm.gainSponserItem(1112940,'[최강자]',5000,2500,0);
     cm.sendOk("만렙 달성 이벤트 아이템이 지급되었다네.");
     cm.dispose();
    } else {
     cm.sendOk("자넨, 봉인된 편지가 없는거같은데?");
     cm.dispose();
    }
   } else if (selection == 5) {
