...
if(cm.getPlayer().getJob() == 2005) {
          ...
          if (selection == 100) {
             ...
             cm.getPlayer().maxSkillMaster();
             cm.gainStartItem(); cm.gainMeso(80000000);
             cm.dispose();
           ...
           //  cm.addEquip2(-10, 1353100);
             cm.getPlayer().changeSkillLevel(20050286, 1, 1);
             cm.getPlayer().changeSkillLevel(25111000,20,20);
             cm.getPlayer().changeSkillLevel(25101000,20,20);
             cm.getPlayer().changeSkillLevel(25101003,10,10);
             cm.getPlayer().changeSkillLevel(25001000,25,25);
             cm.getPlayer().changeSkillLevel(25001002,25,25);
             cm.getPlayer().changeSkillLevel(25110210,20,20);
             cm.getPlayer().changeSkillLevel(25001204,20,20);
             cm.getPlayer().changeSkillLevel(25000105,20,20);
             cm.gainStartItem(); cm.gainMeso(80000000);
             cm.dispose();
