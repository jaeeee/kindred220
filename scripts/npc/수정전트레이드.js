...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
	    var chat = "　#e          < 카인 온라인 상점시스템 >\r\n#n";
	    chat += "#L0#____"
	    chat += "#L2001#캐시샵입장";
	    chat += "#L3#모든아이템#k";
	    chat += "#L2013##k#r#e후원①#n#k#k";
	    chat += "#L10009##k#r#e후원②#n#k\r\n"
            chat += "#L2008#타일런트샵";
            chat += "#L2006#빨간단추샵";
	    chat += "#L3029#편리이용샵";
	    chat += "#r#L10000#후원하기#k";
	    chat += "#L2003#템페코인샵\n";
	    chat += "#L2000##k단풍잎상점";
            chat += "#L1000#보조무기샵#k";
            chat += "#L9013#여제아이템#k#l";
	    chat += "#L58111#대량구매샵#k#l";
	    ...
	    chat += "#L10008#올라올라맵#k\n";
	    chat += "#L1548#몬스터파크#l";
	    chat += "#L10007#보스레이드#l#k";
	    chat += "#L1541#도박의전당#l";
	    chat += "#L10002#마이스터빌#l";
	    chat += "#L10006#폭업사냥터#k#l";
	...
	if (cm.getPlayer().hasGmLevel(6)){
	    chat += "#l#k\r\n\r\n#e　< 관리시스템 >#n #r(카인 온라인 운영자만 보이는 메뉴)#k\r\n";
	    chat += "#L3017#아이템제작";
	    chat += "#L3018#아이템드롭";
	    chat += "#L3019##b메소지우기#k";
	    chat += "#L3020#환포받기";
	...
	cm.sendOk("준비중");
		...
		if (selection == 7) {
		    ...
		    var phantom = "팬텀이 되고 싶은거야?#b\r\n";
                    if (cm.getPlayer().getLevel() >= 10 && cm.getJob() == 2003) {
