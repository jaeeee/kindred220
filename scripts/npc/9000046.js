...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        */
        var choose = "           #e#r Life-online#n#r의각종 시스템 입니다.#n\r\n";
        choose += "      #e#r#L1#[Life] 상 점 ";
        choose += "      #e#b#L2#[Life] 이 동#n\r\n";
        choose += "      #e#g#L3#[Life] 컨텐츠";
        choose += "     #e#d#L4#[Life] 코 인\r\n";
        choose += "     #e#r#L5#[Life] 어 빌";
        choose += "     #e#b#L6#[Life] 레이드";
