...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendGetText("#b#i5064000# #z5064000##k의 갯수를 입력해주세요.\r\n#Cgray#(1개당 3,000,000 메소)");
	} else if (status == 1) {
	var text = cm.getText();
