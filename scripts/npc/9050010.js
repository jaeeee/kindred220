...
function action(mode, type, selection) {
	...
	if (cm.getAndroidGender() == 0) {if (selection == 1) {
        ...
        if (!cm.haveItem(4001126, 10)) {
            cm.sendOk("#b#i4001126# #t4001126# 10개#k가 필요합니다. 아이템을 제대로 갖고 계신것이 맞는지 확인해 주세요.");
            cm.dispose();
            return;
        }
