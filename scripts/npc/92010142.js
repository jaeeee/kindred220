...
//	text += "　※ #e#r한가위 이벤트! 노옵션의 아이템은 무료입니다!#k#n";
	text += "\r\n\r\n"

	text += "#e#b[특수 교환 아이템]#k#n\r\n";
	text += "#L19##i2028048# 메소로 교환하기 (1:20000)#l"
//	text += "#L155##i1522095# 스칼렛웨폰#l\r\n"
//	text += "#L1000##i3700010# #z3700010# #r1개#k [#Cgray#30000원#k]\r\n";
//	text += "#L2##i4001126# #z4001126# #r4000개#k [#Cgray#2000원#k]\r\n";
...
//	text += "#L16##i4310058# [#r1개, #Cgray#6000원#k]#l";
	...
	text += "#e#b[훈장·뱃지 아이템]#k#n (가격 : #Cgray#4500#k원)\r\n";
//	text += "#L3008##i1142249#";
	text += "#L66##i1142558#";
	text += "#L24##i1142593#";
	text += "#L3009##i1182006#";
