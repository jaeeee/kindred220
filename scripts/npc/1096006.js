...
cm.sendSimple("#b[STAR]#k Hello.\r\n #bI am responsible for user master skills\r\n Please choose a career that suits you#k" +"#k\r\n#L80##b#e[adventurer]Skill Master#n#k" +"#k\r\n#L81##b#e[hero]Skill Master" +"#k\r\n#L82##b#e[Cygnus]Skill Master#n#k"+"#k\r\n#L83##b#e[Nova]Skill Master#n#k"+"#k\r\n#L84##b#e[resistance]Skill Master");
} else if (selection == 80) {
cm.sendSimple("#b[STAR]#k Hello.\r\n #bI am responsible for user master skills\r\n Please choose a career that suits you#k" +"#k\r\n#L800##d#e[hero]Skill Master#n#k" +"#k\r\n#L801##d#e[Paladin]Skill Master#n#k" +"#k\r\n#L802##d#e[The Dark Knight]Skill Master#n#K" +"#k\r\n#L803##d#e[Archmage (fire poison)]Skill Master#n#k" +"#k\r\n#L804##d#e[Archmage (Sun. call)]Skill Master#n#k" +"#k\r\n#L805##d#e[bishop]Skill Master#n#k" +"#k\r\n#L806##d#e[Bow Master]Skill Master#n#k" +"#k\r\n#L807##d#e[Shrine]Skill Master#n#k" +"#k\r\n#L808##d#e[Night Road]Skill Master#n#k" +"#k\r\n#L809##d#e[Shadow control]Skill Master#n#k" +"#k\r\n#L810##d#e[Viper]Skill Master#n#k" +"#k\r\n#L811##d#e[Captain]Skill Master#n#k" +"#k\r\n#L812##d#e[Dual Blade]Skill Master#n#k" +"#k\r\n#L815##d#e[Cannon Master]Skill Master#n#k");
} else if (selection == 81) {
cm.sendSimple("#b[STAR]#k Hello.\r\n #bI am responsible for user master skills\r\n Please choose a career that suits you#k" +"#k\r\n#L813##d#e[Mercedes]Skill Master#n#k" +"#k\r\n#L816##d#e[Phantom]Skill Master#n#k" +"#k\r\n#L817##d#e[Aran]Skill Master#n#k" +"#k\r\n#L818##d#e[Evan]Skill Master#n#k" +"#k\r\n#L820##d#e[Luminous]Skill Master#n#k");
} else if (selection == 82) {
cm.sendSimple("#b[STAR]#k Hello.\r\n #bI am responsible for user master skills\r\n Please choose a career that suits you#k" +"#k\r\n#L819##d#e[Mikhail]Skill Master#n#k" +"#k\r\n#L511#[Soul Master]Skill Master" +"#k\r\n#L512#[Flame Wizard]Skill Master" +"#k\r\n#L514#[Stryker]Skill Master" +"#k\r\n#L513#[Windbreaker]Skill Master" +"#k\r\n#L515#[Night Walker]Skill Master");
} else if (selection == 83) {
cm.sendSimple("#b[STAR]#k Hello.\r\n #bI am responsible for user master skills\r\n Please choose a career that suits you#k" +"#k\r\n#L821##d#e[KAISER]Skill Master#n#k" +"#k\r\n#L822##d#e[Angelic Buster]Skill Master#n#k");
} else if (selection == 84) {
cm.sendSimple("#b[STAR]#k Hello.\r\n #bI am responsible for user master skills\r\n Please choose a career that suits you#k" +"#k\r\n#L823##d#e[Battle Mage]Skill Master#n#k" +"#k\r\n#L824##d#e[Waheon]Skill Master#n#k" +"#k\r\n#L825##d#e[Mechanics]Skill Master#n#k" +"#k\r\n#L814##d#e[Daemon Slayer]Skill Master#n#k" +"\k\r\n#L826##d#e[Xenon]Skill Master#n#k" +"#k\r\n#L827##d#e[Daemon Avenger]Skill Master");
...
if (cm.getJob() == 100) {
  ...
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();
} else {
cm.sendOk("hero(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 100) {
  ...
  cm.teachSkill(1220010,10,10); // 어차
...
cm.sendOk("Paladin(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("The Dark Knight(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("아크메이지(불,독)(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 222) {
  ...
  cm.teachSkill(2221009,30,10); // 마스터 매직
  cm.teachSkill(2220010,30,30); // 아케인 에임
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("아크메이지(썬,콜)(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("bishop(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Bow Master(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Shrine(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("나이트 로드(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 400) {
  ...
  cm.teachSkill(4221013,20,20); // Shadow control 인스팅트
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("새도어(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 500) {
  ...
  cm.teachSkill(5121015,30,30); // Viper지션
  cm.teachSkill(5121016,30,30); // 에너지 블라스트
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Viper(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 500) {
  ...
  cm.teachSkill(5220020,30,30); // Captain 디그니티
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Captain(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 400) {
  ...
  cm.teachSkill(4341009,30,30); // Phantom 블로우
  cm.teachSkill(4341002,30,30); // 파이널 컷
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Dual Blade(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Mercedes(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Daemon Slayer(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Cannon Master(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 2400) {
  ...
  cm.teachSkill(20031205,1,1); // Phantom 슈라우드
  ...
  cm.teachSkill(20031210,1,2); // 저지먼트 -- 0차스킬 끝
  cm.teachSkill(24001000,20,20); // 더블 피어싱 -- 1차 스킬 시작
  cm.teachSkill(24001001,20,20); // 탤런트 오브 Phantom시프 Ⅰ
  cm.teachSkill(24001002,15,15); // 스위프트 Phantom
  cm.teachSkill(24000003,10,10); // 퀵 이베이젼 -- 1차 스킬 끝
  cm.teachSkill(24101000,20,20); // 콜 오브 페이트 -- 2차 스킬 시작
  cm.teachSkill(24101001,20,20); // 탤런트 오브 Phantom시프 Ⅱ
  ...
  cm.teachSkill(24111001,20,20); // 탤런트 오브 Phantom시프 Ⅲ
  cm.teachSkill(24111002,20,20); // 럭 오브 Phantom시프
  ...
  cm.teachSkill(24111006,20,20); // Phantom 차지
  cm.teachSkill(24111008,20,20); // Phantom 차지(스킬팅김 방지용)
  cm.teachSkill(24121000,30,30); // 얼티밋 드라이브 -- 4차스킬 시작
  cm.teachSkill(24121001,30,30); // 탤런트 오브 Phantom시프 Ⅳ
...
cm.sendOk("Phantom(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Aran(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("Evan(10차)가 아니면 스킬을 배울수 없습니다.");
dispose();
}
...
cm.sendOk("Mikhail(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 2700) {
  ...
  cm.teachSkill(27001201,20,20); // 선파이어 -- 0차 스킬 시작
...
cm.sendOk("Luminous(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 6100) {
  ...
  cm.teachSkill(61101002,20,20); // 윌 오브소드
  ...
  cm.teachSkill(61110212,20,20); // 윙비트
  ...
  cm.teachSkill(61111008,20,20); // 카탈라이즈
  ...
  cm.teachSkill(61120012,30,30);
  cm.teachSkill(61120007,30,30); // 어드벤스 소드 마스터리
  cm.teachSkill(61121014,30,30); // Nova의 용사
  cm.teachSkill(61120219,30,30); // Nova의 용사
  cm.teachSkill(61121203,30,30); // Nova의 용사
...
cm.sendOk("KAISER(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 6500) {
  ...
  cm.teachSkill(65121009,30,30); // Nova의 용사
  //cm.teachSkill(65121052,1,1); // 엔버 하이퍼스킬 65121052
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Angelic Buster(4th) unless you learn the skill.");
dispose();
}

 

} else if (selection == 515) { // Night Walker
...
cm.sendOk("Night Walker(2,3차)가 아니면 스킬을 배울수 없습니다.");
dispose();
}

} else if (selection == 514) { // Stryker

if (cm.getJob() == 1500) {
cm.teachSkill(15121000,30,30); // Cygnus 나이츠
cm.teachSkill(15121001,30,30); // 섬멸
cm.teachSkill(15121002,30,30); // 벽력
cm.teachSkill(15120003,30,30); // 태풍
cm.teachSkill(15121004,30,30); // 축뢰
cm.teachSkill(15121005,20,20); // 윈드 부스터
cm.teachSkill(15120006,30,30); // 너클 엑스퍼트
cm.teachSkill(15120007,10,10); // 자극
cm.teachSkill(15120008,30,30); // 뇌신
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Stryker(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 1100) {
  cm.teachSkill(11121000,30,30); // Cygnus 나이츠
  cm.teachSkill(11121101,30,30); // 댄스 오브 문
  cm.teachSkill(11121201,30,30); // 스피딩 선셋
  cm.teachSkill(11120009,30,30); // 마스터 오브 더 소드
  cm.teachSkill(11120008,10,10); // 언포시어블
  cm.teachSkill(11120007,30,30); // 소드 엑스퍼트
  cm.teachSkill(11121005,20,20); // 솔루나 타임
  cm.teachSkill(11121006,30,30); // 소울 플레지
  cm.teachSkill(11121004,30,30); // 소울 페네트레이션
  cm.teachSkill(11121103,30,30); // 크레센트 디바이드
  cm.teachSkill(11121203,30,30); // 솔라 피어스
  cm.teachSkill(11121202,1,1); // 스피딩선셋 공중
  cm.teachSkill(11121102,1,1); // 댄스 오브 문 공중
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Soul Master(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("플레임 위자드(2,3차)가 아니면 스킬을 배울수 없습니다.");
dispose();
}
...
if (cm.getJob() == 1300) {
cm.teachSkill(13121000,30,30); // Cygnus 나이츠
cm.teachSkill(13121001,30,30); // 천공의 노래
cm.teachSkill(13120002,30,30); // 스파이럴 볼텍스
cm.teachSkill(13120003,20,20); // 트라이플링 윔3
cm.teachSkill(13121004,30,30); // 윈드 블레싱
cm.teachSkill(13121005,30,30); // 샤프 아이즈
cm.teachSkill(13120006,30,30); // 보우 엑스퍼트
cm.teachSkill(13120007,10,10); // 에메랄드 더스트
cm.teachSkill(13120008,30,30); // 알바트로스 맥시멈
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Windbreaker(4th) unless you learn the skill.");
dispose();
}
...
cm.sendOk("배틀 메이지(4th) unless you learn the skill.");
dispose();
}
...
if (cm.getJob() == 3300) {
  cm.teachSkill(30001061,1,1);;// 포획 -- 0 차스킬 
...
cm.sendOk("와일드 헌터(1,4차)가 아니면 스킬을 배울수 없습니다.");
dispose();
}
...
if (cm.getJob() == 3500) {
  ...
  cm.teachSkill(30001068,1,1); // Mechanics 대쉬 -- 0차 스킬 시작,끝
  ...
  cm.teachSkill(35111002,0,0); // 마그네틱 필드 
  cm.teachSkill(35111004,0,0); // 메탈아머 : 헤비 머신건
  ...
  cm.teachSkill(35121013,0,0); // 메탈아머 : 헤비 머신건
  cm.teachSkill(35120014,5,5); // 더블 럭키 다이스 -- 4차 스킬 끝
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Mechanics(4th) unless you learn the skill.");
dispose();
}} else if (selection == 826) {

if (cm.getJob() == 3600) {

  cm.teachSkill(36001000,20,20); // 애너지 스플라인 -- 1차스킬 시작
  cm.teachSkill(36001001,10,10); // 서든 프로펠
  cm.teachSkill(36001002,20,20); // 인클라인 파워
  cm.teachSkill(36000003,10,10); // 레디얼너브 리파인 
  cm.teachSkill(36000004,1,1); // 멀티래터럴 II
  cm.teachSkill(36001005,4,4); // 핀포인트 로켓
  cm.teachSkill(36101000,20,20); // 퀵실버 소드 : 섬광 -- 2차시작
  cm.teachSkill(36101001,15,15); // 이온 쓰러스터
  cm.teachSkill(36101002,20,20); // 리니어 퍼스펙티브
  cm.teachSkill(36101003,10,10); // 에피션시 파이프라인
  cm.teachSkill(36101004,10,10); // Xenon 부스터
  cm.teachSkill(36101005,5,5); // 마이너리티 서포트
  cm.teachSkill(36101006,20,20); // Xenon 마스터리
  cm.teachSkill(36100007,20,20); // 멀티래터럴 III
  cm.teachSkill(36101008,20,20); // 퀵실버 소드 : 집중
  cm.teachSkill(36101009,20,20); // 퀵실버 소드 : 도약
  cm.teachSkill(36100010,20,20); // 핀포인트 로켓 1차 강화
  cm.teachSkill(36111000,20,20); // 컴뱃 스위칭:폭발 -- 3차 시작
  cm.teachSkill(36111001,20,20); // 다이아그널 체이스 
  cm.teachSkill(36111002,20,20); // 필라 스크램블 
  cm.teachSkill(36111003,20,20); // 듀얼브리드 디펜시브 
  cm.teachSkill(36110004,10,10); // 이지스 시스템
  cm.teachSkill(36110005,10,10); // 트라이앵글 포메이션
  cm.teachSkill(36111006,20,20); // 버추얼 프로젝션
  cm.teachSkill(36110007,1,1); // 멀티래터럴 IV
  cm.teachSkill(36111008,5,5); // 엑스트라 서플라이
  cm.teachSkill(36111009,20,20); // 컴뱃 스위칭 : 격추
  cm.teachSkill(36111010,20,20); // 컴뱃 스위칭 : 분열
  cm.teachSkill(36110012,4,4); // 핀포인트 로켓 2차 강화
  cm.teachSkill(36121000,30,30); // 블레이드 댄싱 -- 4차 시작
  cm.teachSkill(36121001,30,30); // 퍼지롭 매스커레이드 : 저격
  cm.teachSkill(36121002,30,30); // 홀로그램 그래피티 : 관통
  cm.teachSkill(36121003,30,30); // 오파츠 코드
  cm.teachSkill(36121004,30,30); // 오펜시브 매트릭스
  cm.teachSkill(36121005,10,10); // 인스턴트 셔크
  cm.teachSkill(36121006,30,30); // Xenon 엑스퍼트
  cm.teachSkill(36121007,1,1); // 타임 캡슐
  cm.teachSkill(36121008,30,30); // 메이플 용사
  cm.teachSkill(36121009,5,5); // 용사의 의지
  cm.teachSkill(36121010,1,1); // 멀티래더럴 V
  cm.teachSkill(36121011,20,20); // 퍼지롭 매스커레이드 :포격
  cm.teachSkill(36121012,20,20); // 퍼지롭 매스커레이드 : 폭격
  cm.teachSkill(36121013,10,10); // 홀로그램 그래피티 : 역장
  cm.teachSkill(36121014,10,5); // 홀로그램 그래피티 : 지원
  cm.teachSkill(36121015,1,1); // 핀포인트 로켓 최종 강화
  cm.teachSkill(36121016,1,1); // 멀티래더럴 VI
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Xenon(4th) unless you learn the skill.");
dispose();
}} else if (selection == 827) {

if (cm.getJob() == 3100) {

  cm.teachSkill(30010185,1,1); // 데모닉 블러드 -- 0차스킬 시작 / 끝
  cm.teachSkill(31011000,20,20); // 익시드:더블크로스 -- 1차스킬 시작
  cm.teachSkill(31011001,20,20); // 릴리즈 오버로드
  cm.teachSkill(31010002,10,10); // 앱졸브 라이프
  cm.teachSkill(31010003,15,15); // 데모닉 샤프니스 -- 1차스킬 끝
  cm.teachSkill(31201000,20,20); // 익시드:데몬 스트라이크 -- 2차스킬 시작
  cm.teachSkill(31201001,20,20); // 배츠 스웜
  cm.teachSkill(31201002,20,20); // 데몬 부스터
  cm.teachSkill(31201003,20,20); // 어비셜 레이지
  cm.teachSkill(31200004,10,10); // 솔리드 윌
  cm.teachSkill(31200005,10,10); // 데스페라도 마스터리
  cm.teachSkill(31200006,5,5); // 이너 스트렝스 -- 2차스킬 끝
  cm.teachSkill(31211000,20,20); // 익시드:문라이트 슬래시 -- 3차스킬 시작
  cm.teachSkill(31211001,20,20); // 인헤일 바이탈러티
  cm.teachSkill(3121100,20,20); // 쉴드 차지
  cm.teachSkill(31211003,20,20); // 리프랙트 이블
  cm.teachSkill(31211004,20,20); // 디아볼릿 리커버리
  cm.teachSkill(31210005,20,20); // 이즈 익시드 페인
  cm.teachSkill(31210006,5,5); // 어드밴스드 앱졸브 라이프 -- 3차스킬 끝
  cm.teachSkill(31221000,10,10); // 익시드:엑스큐션 -- 4차스킬 시작
  cm.teachSkill(31221001,10,10); // 쉴드 체이싱 
  cm.teachSkill(31221002,10,10); // 아머 브레이크 
  cm.teachSkill(31221003,10,10); // 블러디 임프리즌
  cm.teachSkill(31221004,30,30); // 오버휄밍 파워
  cm.teachSkill(31220005,30,30); // 디펜스 엑스퍼타이즈
  cm.teachSkill(31220006,30,30); // 어드밴스드 데스페라도 마스터리
  cm.teachSkill(31220007,10,10); // 인핸스드 익시드
  cm.teachSkill(31221008,10,10); // 메이플 용사 -- 4차 끝
  cm.sendOk ("Skill MasterIt has been completed.");
  dispose();

} else {
cm.sendOk("Daemon Avenger(4th) unless you learn the skill.");
dispose();
}
