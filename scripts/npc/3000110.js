...
var status = -1;
	...
	cm.sendSimple("#i"+item+"# #r"+count+"개#k로 "+bn+"을(를) 소환하겠습니까? \r\n\r\n#L1##r#i"+item+"# #r"+count+"개#k로 "+bn+" 소환\r\n#l#L2#마을로 가기#l#k\r\n\r\n#l#L3##b계속죽이라고할때클릭해주세요.<킬올시스템>\r\n		(아이템 드랍은 되지않습니다.)#l#k\r\n");
		...
		if(selection == 1) {//소환
			...
			WorldBroadcasting.broadcast(MainPacketCreator.serverNotice(6, "　　　　　　　　　　　::::::::["+ cm.getPlayer().getName()+"] 님께서 "+(cm.getClient().getChannel()+1) +" 채널에서 "+bn+"을(를) 소환하셨습니다.::::::::")); // 게임 채팅서버알림 메세지 
