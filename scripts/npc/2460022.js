...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	    cm.sendSimple("지금보다 더 매력적으로 변하고 싶지 않나요?#e#n\r\n\r\n#L0##b피부#k#L1##b머리#k#L2##b머리색#k#L3##b얼굴#k#L4##b눈색깔#k#L5##b성전환하기#k#l #k#L6##b안드로이드");	
    } else if (status == 1) {
        if (selection == 6) {
            cm.dispose();
            cm.openNpc(1012123);
