 ...
 */
var list1 = [1702538,1702535,1022230,1004181,1052762,1702525,1003089,1072443,1082272,1003836,1003837,1050210,1051256,1003376,1102325,1051176,1050148,1050208,1051254,1050186,1051218,1050303,1051371,1702277,1052601,1072809,1051348,1072810,1052603,1072811,1003367,1102326,1702330,1050209,1051255,1003460,1052438,1702350]; // 
var list2 = []; // 
	...
	cm.sendGetNumber("\r\n#e선택 아이템#n : #i"+itemid+"# #z"+itemid+"#\r\n#e아이템 가격#n : #b#e"+cost+"#n 후원포인트#k\r\n\r\n#r※ 100 후원포인트#k = #b올스텟 ＋5#k\r\n",1,1,cm.getPlayer().getRC());
		...
		return;
            ...
            if (cm.getMeso() + meso > 9999999999) {
                ...
                cm.gainMeso(meso);
                cm.getPlayer().gainRC(meso / 20000);
