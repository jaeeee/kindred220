...
var status = -1;
var givefame = Math.floor(Math.random()*1) + 5000;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
 	...
 	cm.sendGetText("\r\n#k#n현재 환생포인트 #e:#n #r"+cm.getPlayer().getFame()+"#k　환생 가능 레벨 #e:#n #r250#k\r\n환생시 얻을 수 있는 환생포인트(AP = 스텟) #e:#n #r10000 #k\r\n#k\r\n\r\n환생 하시려면 #b'환생'#k을 입력해주세요.");
	}


                        else if (status == 1) {
			if (cm.getText().equals("환생") && cm.getPlayer().getLevel() >= 250 && cm.canHold(4310034)) {
