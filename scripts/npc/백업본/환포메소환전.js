...
function action(mode, type, selection) {
	...
	cm.sendYesNo("안녕하세요 #h0#님.#b메소 환전#k을 하시겠습니까?\r\n#b 1 환포포인트#k당 #r100000#k 메소를 얻으실 수 있습니다.\r\n현재 #h0#님의 환생포인트는 #r#e"+cm.getPlayer().getFame()+" #n#k입니다.\r\n만약 환전을 원하신다면 #b[예]#k버튼을 눌러주시고 \r\n아니라면 #r[아니오]#k버튼을 눌러주세요.");
	}else if (status == 1){
	cm.sendGetText("환전 할 환생포인트를 적어주세요. \r\n반드시 #r숫자#k만 입력해주시기 바랍니다.");
	}else if (status == 2){
	var text = cm.getText();
	...
	cm.sendOk("환생포인트가 부족하거나, 메소가 너무 많습니다.");
	cm.dispose();
	}
}
}
