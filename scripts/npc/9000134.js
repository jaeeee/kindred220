...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
	if (status == 0) {
		var chat = "안녕하세요!! 저는 #bHuman Project#k에서 팀장직을 담당하고있는 \r\n#bHuman[GM]#k라고 합니다! ";
		chat += "저가 이렇게 #b휴먼시스#k에 있는 이유는!! 바로바로 #d에픽아이템#k을 판매하기 위해서 왓답니다~\r\n";
		chat += "#d에픽아이템#k이 뭐냐구요? #b휴먼스토리#k에서만 볼수있는 엄청 #e강력한 아이템#n을 말하는 거에요 ";
		chat += "하지만 #d에픽아이템#k은 손쉽게 획득 할수는 없죠!! 저에게 #b(5천만)50,000,000#k메소를 주시면";
