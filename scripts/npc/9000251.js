...
var arr = new Array(1212063,1222058,1232057,1242060,1302275,1312153,1322203,1332225,1342082,1362090,1372177,1382208,1422140,1432167,1442223,1452205,1462193,1472214,1482168,1492179,1522094,1532098,1402196,1412135);
...
function start() {
	var st = "옵션을 부여하실 아이템을 선택해주세요.\r\n\r\n나의 후원 마일리지 #r#e: "+cm.getRC()+"\r\n#n#k";
	st += "#L1##b소지중인 이미 옵션이부여된 파프니르 업그레이드#k\r\n\r\n";
