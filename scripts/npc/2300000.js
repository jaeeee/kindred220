...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
 cm.sendSimple("#b#L1##i2541007# 머리 모양#l　#L3##i5152057# 얼굴#l#e　#n#L6##i1662039# 안드로이드\r\n\r\n#L0##i5153015# #b피부 색깔#l　#L2##i5151036# 염색#l　#L4##i5152100# 컬러렌즈\r\n\r\n#L5##r#e성별을 바꿀래.#k#l#L7##b#e신 성형헤어로 갈래.#k#l#L111##b#e제로 세팅#k#l");
    } else if (status == 1) {
        if (selection == 6) {
            cm.dispose();
            cm.openNpc(1012123);
        ...
        if (selection == 111) {
cm.sendOk("#e#r제로#k#n를 성형하시려면 스킬을 써서 성별을 바꾸고 하시면됩니다.");
cm.dispose();
        }
