...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var chat= "안녕하세요. 저는 마을에서 모든상점을 관리중인 제크 라고합니다.\r\n\r\n";
	    chat += "#L4##b모든상점#k 을 이용하겠습니다.\r\n";
	    chat += "#L5##b코인상점#k을 이용하겠습니다.\r\n";
	    chat += "#L6##b장비상점#k 을 이용하겠습니다.\r\n";
	    chat += "#L99##r#e[EVENT]#k#d 후원 아이템 상점#k\r\n\r\n#l";
