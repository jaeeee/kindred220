...
var itemsz0 = new Array(new Array(18, 1302275, 18), new Array(18, 1312153, 18), new Array(18, 1322203, 18), new Array(18, 1402196, 18), new Array(18, 1412135, 18), new Array(18, 1422140, 18), new Array(18, 1432167, 18), new Array(18, 1442223, 18));
var itemsz1 = new Array(new Array(18, 1212063, 18), new Array(18, 1382208, 18), new Array(18, 1372177, 18), new Array(18, 1452205, 18), new Array(18, 1462193, 18), new Array(18, 1522094, 18), new Array(18, 1332225, 18));
var itemsz2 = new Array(new Array(18, 1472214, 18), new Array(18, 1342082, 18), new Array(18, 1482168, 18), new Array(18, 1492179, 18), new Array(18, 1532098, 18), new Array(18, 1362090, 18), new Array(18, 1222058, 18), new Array(18, 1242063, 18));
...
function action(mode, type, selection) {
	...
	var leaf = cm.itemQuantity(4310129);
        var trade = "#b앱솔랩스 아이템#k 상점입니다. 어떤 아이템을 원하세요?\r\n아, 참고로 앱솔랩스 아이템은 #b#i4310067##z4310067##k 18개로 교환하실수 있습니다. #b#i4310067##z4310067##k은 #r 초기자원으로500개지급 후원으로 지급합니당.#k\r\n";
