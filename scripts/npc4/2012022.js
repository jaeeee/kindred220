...
function action(mode, type, selection) {
	...
	if (selectedType == 0){
	var items = new Array (2070000, 2070001, 2070002, 2070003, 2070004, 2070005, 2070007, 2070023, 2070024);
	var selStr = "어떤 표창을 만들지 선택하자. 표창의 종류에 따라 제작 횟수가 있는 것 같다.\r\n\r\n#b";
	selStr += "#e#r[일반 제련 표창 (밸런스 조정으로 일비표창은 클리프 잡화상점에 있습니다.)]#k#n\r\n";
	for (i = 0; i < 7; selStr += "#b#L"+i+"##i"+items[i]+"# #z"+items[i]+"##l\r\n",i++); selStr += "\r\n\r\n";
	selStr += "#e#r[특수 제련 표창]#k#n\r\n";
	for (i = 7; i < 9; selStr += "#b#L"+i+"##i"+items[i]+"# #z"+items[i]+"##l\r\n",i++); selStr += "\r\n\r\n";
