...
function start() {
	if(cm.getPlayer().getGMLevel()>5){
		...
		cm.sendOk("운영자가 아닌 사람은 이용하실 수 없습니다. #h #님의 이용기록이 저장됩니다.");
		cm.dispose();
	}
}
