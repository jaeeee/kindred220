...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
    if (status == 0) {
            var chat = "#d#e안녕하세요 #h #님 #r#e직업을#k #d#e골라주세요.\r\n\r\n";
            ...
            if (cm.getPlayer().getJob() == 0) {
                ...
                chat += "#L28# 저는 #i1312065##r데몬슬레이어#k #r게임#k을 시작하고 싶습니다.\r\n";
                chat += "#L30# 저는 #i1232014##r데몬어벤져#k #r게임#k을 시작하고 싶습니다.\r\n";
                cm.sendSimple(chat);
	        ...
	        cm.gainSponserItem(1002450,'[초기지원]',1000,100,0); //소라 모자
	        cm.gainSponserItem(1142477,'[초기지원]',1000,100,0); //스우스토리 칭호
                cm.dispose();
