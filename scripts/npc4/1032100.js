var list1 = [1001110,1051450,1073084,1102848,1702620]; // 키네시스 세트
var list2 = [1004568,1051441,1073079,1102844,1702607]; // 래빗마우스 세트
var list3 = [1004541,1051439,1073075,1702595,1102836]; // 티파티 세트
var list4 = [1004527,1051437,1071085,1102831,1702591]; // 플라잉 세트
var list5_1 = [1004139,1052754,1082587,1102685,1702505]; // 인형 세트
var list6 = [1004486,1051434,1073056,1102822,1702586]; // 봄 세트
var list7 = [1004336,1052576,1072783,1102832,1102766]; // 스우 세트
var list8 = [1004192,1051405,1072943,1102706,1702528,1112949]; // 멜로디 세트
var list9 = [1004180,1042319,1062207,1082588,1072934,1702523]; // 호이포이 무지개 세트
var list10 = [1004158,1051392,1071078,1102688,1702512]; // 파티 다이어리 세트
var list11 = [1051391,1081013,1071077,1702504]; // 엘사 세트
var list12 = [1001112,1051454,1081015]; // 펭귄 세트
...
function action(mode,type,selection) {
	...
	cm.sendGetNumber("\r\n#e선택 아이템#n : #i"+itemid+"# #z"+itemid+"#\r\n#e아이템 가격#n : #b#e"+cost+"#n 후원포인트#k\r\n\r\n#e#Cgray#※ "+allstatprice+" 후원포인트 = 올스텟 ＋"+allstat+" #k#n\r\n#r※ 100 후원포인트#k = #b공격력/마력 ＋2#k",1,1,cm.getPlayer().getRC()  - cost);
}
}
	} else if (status == 3) {
	if (selected == 999999) {
