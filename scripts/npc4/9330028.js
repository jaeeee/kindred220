 ...
 */
var list1 = [1051391,1081013,1071077,1050321,1080007,1070060,1702504]; // 겨울왕국
var list2 = [1002186,1012289,1032024,1022079,1072153,1082102,1102039]; // 투명 세트

var list3 = [1004192,1050335,1051405,1702528,1072943]; // 바캉스 레인보우

var list4 = [1003109,1052275,1072448,1102245]; // 로얄 레인보우
var list5_1 = [1003398,1003399,1003400,1003401,1003402]; // 기사단장 1세트 + 1004177
...
var list46 = [1000070,1001093,1050312,1051384,1082580,1072908,1702488]; // 마스터 포니 세트
...
//1042294
var accessory_1 = [1022188,1022174,1022177,1022196,1022229,1022223];
...
function action(mode,type,selection) {
	...
	if (selected == 999999) {
	cost = capes.toString().search(selection) % 8 == 0 ? 2000 : seclist.toString().search(selection) % 8 == 0 ? 3000 : 1500;
	itemid = selection;
	...
	cm.sendGetNumber("\r\n#e선택 아이템#n : #i"+itemid+"# #z"+itemid+"#\r\n#e아이템 가격#n : #b#e"+cost+"#n 후원포인트#k\r\n\r\n#e#Cgray#※ "+allstatprice+" 후원포인트 = 올스텟 ＋"+allstat+" #k#n\r\n#r※ 500 후원포인트#k = #b공격력/마력 ＋3#k",1,1,cm.getPlayer().getRC());
}
}
	} else if (status == 3) {
	if (selected == 999999) {
