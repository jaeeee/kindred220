...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	var change = "안녕하세요…. 혹시 #h #님이 맞으신가요? 위대하신 분을 만나게 되어 영광이에요. 저는  코디네이터 #p9010033#이라고 해요. 특별히 #h #님을 위해 무료로 외형을 바꿔드릴게요…! 물론 꼭 지금 바꾸셔야 된다는게 아니라 나중에 천천히 바꾸셔도 되요. #n\r\n";
	change += "#L1##i5150057# #b머리 모양#k#l ";
	change += "#L3##i5152057# #b얼굴#k#l ";
	change += "#L6##i1662003# #b안드로이드#k\r\n\r\n";
	change += "#L0##i5153015# #b피부 색깔#k#l  ";
	change += "#L2##i5151036##e #n#b염색#k#l";
	change += "#L4##i5152100# #b컬러렌즈#k#l";	
