...
function action(mode , type , selection){
	...
	if (mode > 0)
	    ...
	    status--;
	if (status == 0) {
            cm.sendYesNo("#bHi~Hello#e메리스토리#n #e초기 지원 아이템#n을 보급중인 NPC입니다..\r\n지금#e메리스토리#n은 #i1004384##i1082634##i1052865##i1073019##i1142140##i4310067#이 아이템들을\r\n배급 중입니다. #e#r(올스텟 500 , 공격력,마력 30)\r\n#r\r\n#b아이템을 받으시겠습니까??\r\n#r※장비칸 5칸을 남겨두세요~")
        } else if (status == 1){
	    ...
	    cm.gainSponserItem(1142140,'[초기지원]',500,30,30); //메리스토리유저
            cm.gainItem(4310067, +500);(43100,'[초기지원]',500,30,30); //후원코인
