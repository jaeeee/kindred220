...
public class SearchToCode extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText(", Separated by saving");
        ...
        jButton2.setText("Get off one space saving");
    ...
    String name = JOptionPane.showInputDialog(null, "Please enter a filename");
    FileOutputStream out = null;
    try {
      out = new FileOutputStream("" + name + ".txt", false);
      out.write(임시1.toString().getBytes());
    } catch (Exception ex) {} finally {
      try {if (out != null) out.close(); } catch (IOException ex){}JOptionPane.showMessageDialog(null, "Saved successfully.");}
