...
public class CheatingOffensePersister {
	...
	public void run() {
		...
		PreparedStatement insertps = con.prepareStatement("INSERT INTO cheatlog (characterid, offense, count, lastoffensetime, param) VALUES (?, ?, ?, ?, ?)", MYSQL.RETURN_GENERATED_KEYS);
