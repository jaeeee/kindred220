...
public class WorldCommunity {
     ...
     * @since Revision 33
     */
    public static boolean 얼리기 = false;
    ...
    public static void 아르미() {
        아르미 = true;
        아르미캔슬();
        WorldBroadcasting.broadcastMessage(MainPacketCreator.startMapEffect("아르미 : 우와~ 예쁜 폭죽이 터졌어요!", 5120009, true));
    } 
    ...
    public static void 아르미캔슬() {
            ...
            @Override
            public void run() {
                WorldBroadcasting.broadcastMessage(MainPacketCreator.startMapEffect("아르미 : 여러분 아쉽지만 화약이 다 떨어져 버렸어요 ㅠ.ㅠ 다음에 또 만나요~", 5120009, true));
                아르미 = false;
          }
       }, 3600000);
    }
