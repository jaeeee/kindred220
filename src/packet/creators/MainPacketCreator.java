...
public static Packet removeSoul(int oid, int cid) {
    ...
    public static Packet updateSp(MapleCharacter chr, final boolean itemReaction) { //this will do..
    ...
    public static Packet spawnSummon(MapleSummon summon, int skillLevel, boolean animated) {
        ...
        packet.write(summon.getSkill() == 33101008 || summon.getSkill() == 5321004 || summon.getSkill() == 5320011 || summon.getSkill() == 61101002 || summon.getSkill() == 101100100 || summon.getSkill() == 14000027 || summon.getSkill() == 22171052 ? 5 : summon.getSkill() == 14121003 ? 4 : summon.getOwner().getMap() != null ? summon.getOwner().getMap().getFootholds().findMaple(summon.getPosition()).getId() : 4);
        packet.writeShort(GameConstants.isAngel(summon.getSkill()) ? 25 : summon.getSkill() == 23111009 ? 104 : summon.getSkill() == 23111010 ? 106 : summon.getSkill() == 1301013 ? 249 : summon.getSkill() == 33101008 ? 174 : summon.getSkill() == 35121011 ? 23 : summon.getSkill() == 14000027 ? 2 : (summon.getSkill() == 14111024 || summon.getSkill() == 14121054 || summon.getSkill() == 14121055 || summon.getSkill() == 14121056) ? 12 : (summon.getSkill() == 35121003 || summon.getSkill() == 14121003 || summon.getSkill() == 12111022) ? summon.getOwner().getMap().getFootholds().findMaple(summon.getPosition()).getId() : 0); 
        packet.write(summon.getMovementType().getValue()); // 0 = don't move, 1 = follow (4th mage summons?), 2/4 = only tele follow, 3 = bird follow
...
//        System.out.println("Equip Size : "+equip.size());
    ...
    public static Packet GainEXP_Monster(final int gain, final boolean white, final int partyinc, final int Class_Bonus_EXP, final int elfBlessing, final int buff, final int exp, final int event) {
        final WritingPacket packet = new WritingPacket();
        packet.writeShort(SendPacketOpcode.SHOW_STATUS_INFO.getValue());
    ...
    public static Packet spawnPlayerMapobject(MapleCharacter chr) {
        ...
        if (chr.getBuffedValue(BuffStats.MECH_CHANGE) != null) {
            ...
            buffvalue.add(new Pair<Integer, Integer>(Integer.valueOf(chr.getBuffedValue(BuffStats.MECH_CHANGE).intValue()), 2));
        ...
        if (chr.getBuffedValue(BuffStats.DARK_AURA) != null) {
            ...
            buffvalue.add(new Pair<Integer, Integer>(Integer.valueOf(chr.getBuffedValue(BuffStats.DARK_AURA).intValue()), 2));
        ...
        if (chr.getBuffedValue(BuffStats.BLUE_AURA) != null) {
            ...
            buffvalue.add(new Pair<Integer, Integer>(Integer.valueOf(chr.getBuffedValue(BuffStats.BLUE_AURA).intValue()), 2));
        ...
        if (chr.getBuffedValue(BuffStats.YELLOW_AURA) != null) {
            ...
            buffvalue.add(new Pair<Integer, Integer>(Integer.valueOf(chr.getBuffedValue(BuffStats.YELLOW_AURA).intValue()), 2));
    ...
    public static Packet summonAttack(final int cid, final int summonSkillId, final byte animation, final List<SummonAttackEntry> allDamage, final int level, boolean darkFlare) {
        WritingPacket packet = new WritingPacket();
    ...
    public static Packet attack(RecvPacketOpcode op, MapleCharacter player, int cid, byte tbyte, int skill, int level, int display, byte animation, byte speed, List<AttackPair> damage, final Point pos, final byte mastery, final int charge, final int lvl, final int itemid) {
        WritingPacket packet = new WritingPacket();
        ...
        if ((op == RecvPacketOpcode.RANGED_ATTACK)) {
            if ((skill == 13111020) || (skill == 35121012) || (skill == 13121052) || (skill == 5121017) || (skill == 3221017) || (skill == 3221001) || (skill == 4121013) ||
                    (skill == 13121002) || (skill == 5221016) || (skill == 5321012) || (skill == 51121008) || (skill == 3111013) || (skill == 5121016) || (skill == 5321000) ||
                    (skill == 3121015) ||(skill == 3121020) || (skill == 14121002)) { //소지하고 있는 표창이나 화살이 이펙트로 나오는 스킬.
                        boolean visProjectile = itemid > 0; //캐시 표창 등 이펙트 표창의 아이템 값이 클시.
        ...
        for (AttackPair oned : damage) {
            if (oned.attack != null) {
                ...
                if (skill == 2321001 || skill == 2221052 || skill == 11121052 || skill == 12121054 || skill == 12121055) {
                    packet.writeInt(0);
                } else if (skill == 14121052 || skill == 15121052 || skill == 4221052 || skill == 65121052 || skill == 80001431 || skill == 100001283 || skill == 80001429 || skill == 604066660 || skill == 101000202 || skill == 101000102) {
                    packet.writeInt(0);
                    packet.writeInt(0);
                }
                if (op == RecvPacketOpcode.RANGED_ATTACK) {
        ...
        //System.out.println("Opcode : " + op + " ItemId : " + itemid + " Packet : " + packet);
        return packet.getPacket();
    }
    ...
    public static Packet confirmShopTransactionAdditional(int sid, List<MapleShopItem> items, MapleShop shop, final MapleClient c) {
        WritingPacket packet = new WritingPacket();
        packet.writeShort(SendPacketOpcode.CONFIRM_SHOP_TRANSACTION.getValue());
        packet.write(7); // 8 = sell, 0 = buy, 0x20 = due to an error <- 160은 (4) 168은 (5)
        addShopInfo(packet, c, sid, items);
    ...
    public static Packet giveBuff(int buffid, int bufflength, List<Triple<BuffStats, Integer, Boolean>> statups, SkillStatEffect effect, Map<BuffStats, List<StackedSkillEntry>> stacks) {
        boolean MW = false;
        WritingPacket packet = new WritingPacket();
        packet.writeShort(SendPacketOpcode.GIVE_BUFF.getValue());
        PacketProvider.writeLongMask(packet, statups);
        ...
        if (buffid == 1211014 || buffid == 32001003 || buffid == 32120013 || buffid == 32101003 || buffid == 32120014 
            || buffid == 32111012 || buffid == 32120015 || buffid == 2221054 || buffid == 36121003 || buffid == 11101022 
        ...
        } else if (effect.isPhantomSkill() || MW || buffid == 2111008 || buffid == 5101011 || buffid == 5121015 || buffid == 5111010 || buffid == 31211003 
                || buffid == 31211004 || buffid == 31221004 /*|| buffid == 32121010 배틀 레이지 오류*/ || buffid == 15121000 || buffid == 24121054  || buffid == 27111004 
                || buffid == 27111006 || buffid == 61121009 || buffid == 61121014 || buffid == 65121009 || buffid == 36121003  || buffid == 2211008 
                || buffid == 1211011 || buffid == 2111011 || buffid == 3211011 || buffid == 36101003 || buffid == 36121054 || buffid == 14001021
                || buffid == 23111005 || buffid == 23111004 || buffid == 27121006 || buffid == 31121007 || buffid == 24111005 || buffid == 24111002
                || buffid == 24111003 || buffid == 24121004) {
        ...
        } else if (buffid == 3121002 || buffid == 3121007 || buffid == 3221002 || buffid == 4221013 || buffid == 13121005 || buffid == 14001022 
                || buffid == 33121004 || buffid == 21101005 || buffid == 32111014 || buffid == 36111003) {
        ...
        if (effect.isAddedByte() || MW || (!effect.isSkill() && !effect.isInflation())) {
            packet.write(buffid == 4301003 || buffid == 33111007 || buffid == 61111008 || buffid == 61120008 || buffid == 61121053 
                    || buffid == 80001427 ? 1 : 0);
        }
    ...
    public static Packet giveForeignBuff(int cid, List<Triple<BuffStats, Integer, Boolean>> statups, SkillStatEffect effect) {
        ...
        packet.writeInt(cid);
        PacketProvider.writeLongMask(packet, statups);
        if ((effect.getSourceId() == 61120008) || (effect.getSourceId() == 61111008) || (effect.getSourceId() == 61121053)) {
            packet.write(10);
        ...
        for (Triple<BuffStats, Integer, Boolean> statup : statups) {
            ...
            if (statup.getFirst() == BuffStats.SHADOWPARTNER
                    || statup.getFirst() == BuffStats.MECH_CHANGE
                    ...
                    || statup.getFirst() == BuffStats.DARK_AURA
                    || statup.getFirst() == BuffStats.YELLOW_AURA
                    || statup.getFirst() == BuffStats.POWER_TRANSFER
                    || statup.getFirst() == BuffStats.BLUE_AURA
                    ...
                    || statup.getFirst() == BuffStats.SOLUNA_TIME
        ...
        if (effect.getSourceId() == 13101024) {
            ...
            packet.write(1);
            packet.write0(22);
        } else if (effect.getSourceId() == 11111001 || effect.getSourceId() == 11110005) { //콤보 어택
            packet.writeLong(1);
            packet.writeLong(0);
            packet.write0(4);
            ...
            packet.write0(20);
            packet.writeShort(720);
        } else if (effect.getSourceId() == 3101004 || effect.getSourceId() == 3201004 || effect.getSourceId() == 13101003 || effect.getSourceId() == 33101003 || effect.getSourceId() == 4001003) {
            packet.write0(20);
    ...
    public static Packet showBuffeffect(int cid, int skillid, int effectid, int playerLevel, int skillLevel, byte direction) {
        WritingPacket packet = new WritingPacket();
        packet.writeShort(SendPacketOpcode.SHOW_FOREIGN_EFFECT.getValue());
        packet.writeInt(cid);
   ...
   public static Packet arrangeStorage(byte slots, Collection<IItem> items, boolean changed) {
    ...
    public static Packet spawnMist(final MapleMist mist) {
        ...
        packet.writeInt(mist.isShelter() ? 2 : (mist.isBurningRegion() || mist.isTimeCapsule() || mist.getSourceSkill().getId() == 80001431) ? 0 : mist.getSourceSkill().getId() == 35121052 ? 3 : 1);
        if (mist.getOwner() != null) {
    ...
    public static Packet requestBuddylistAdd(int cidFrom, String nameFrom,
            int levelFrom, int jobFrom, MapleClient c) {
        WritingPacket mplew = new WritingPacket();
    ...
    public static Packet triggerReactor(MapleReactor reactor, int stance) {
        ...
        packet.write(0);
        packet.write(0); // frame delay, set to 5 since there doesn't appear to be a fixed formula for it
    ...
    public static Packet guildSkillPurchased(int gid, int sid, int level, long expiration, String purchase, String activate, MapleCharacter chr) {
        WritingPacket packet = new WritingPacket();
    ...
    public static Packet absorbingWP(int oid, int room, int wp, MapleCharacter chr) {
        ...
        packet.writeInt(0);
        packet.writeLong(0);
        packet.write(HexTool.getByteArrayFromHexString("E0 79 37 89")); //1.2.220+ 그리고 유동
        packet.writeInt(0); //1.2.220+
        packet.write(0); //1.2.220+
